...
class Good extends BaseModel
{
    ...
    protected $hidden = ['id', 'os', 'platform', 'related_id', 'sort', 'type', 'uuid', 'test_type'];
    protected $fillable = [
        'app_name',
        'product_id',
        'os',
    ...
    const PLATFORM_MAPPING = [
        ...
        self::PLATFORM_STR_GOOGLE     => self::PLATFORM_GOOGLE,
        ...
        self::PLATFORM_GOOGLE         => self::PLATFORM_STR_GOOGLE,
    ];
