...
class AuthController extends BaseController
{
    ...
    public function auth(AuthRequest $request)
    {
        ...
        if ($userInfo->hide == User::AUTO_HIDE) {
            ...
            pocket()->netease->sendSystemMessage($userInfo->uuid, '由于之前太久未活跃，系统降低了你的排序减少曝光。现已恢复，多活跃才可以获得更多曝光，不方便时可前往“我的”→“设置”页面操作隐身~');
        }
    ...
    public function verifyChannel(int $userId)
    {
        ...
        logger()->setLogType('verify_channel_' . $userId)->error($channel);
