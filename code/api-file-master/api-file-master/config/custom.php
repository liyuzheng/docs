...
return [
    ...
    'menu'                     => [
        ...
        'moment'  => [
            [
                'topic'   => [
                    ['key' => 'hot', 'name' => 'menus.popular', 'show_banner' => 1],
                    ['key' => 'lbs', 'name' => 'menus.nearby', 'show_banner' => 1],
                    ['key' => 'new', 'name' => 'menus.latest', 'show_banner' => 1]
                ],
                'moment'  => [
                    ['key' => 'new', 'name' => 'menus.all', 'show_banner' => 1],
                    ['key' => 'lbs', 'name' => 'menus.nearby', 'show_banner' => 1],
                ],
        ...
        'lbs_menu' => [
            [
                'man'     => [
                    ['key' => 'lbs_all', 'name' => 'menus.distance_first', 'style' => 'square'],
                    ['key' => 'lbs_online', 'name' => 'menus.online_girls', 'style' => 'square'],
                    ['key' => 'lbs_new', 'name' => 'menus.new_girls', 'style' => 'square']
                ],
                'woman'   => [
                    ['key' => 'lbs_all', 'name' => 'menus.all_boys', 'style' => 'list'],
                    ['key' => 'lbs_online', 'name' => 'menus.online_boys', 'style' => 'list'],
                    ['key' => 'lbs_vip', 'name' => 'menus.vip_boys', 'style' => 'list'],
                    ['key' => 'lbs_girl', 'name' => 'menus.girls', 'style' => 'list']
                ],
                'version' => version_to_integer('1.0.0')
            ],
            [
                'man'     => [
                    'a'    => [ //奇数
                        ['key' => 'lbs_online', 'name' => 'menus.online_first', 'style' => 'square'],
                        ['key' => 'lbs_all', 'name' => 'menus.distance_first', 'style' => 'square'],
                        ['key' => 'lbs_new', 'name' => 'menus.new_entrant_first', 'style' => 'square']
                    ],
                    'b'    => [ //偶数
                        ['key' => 'lbs_online', 'name' => 'menus.online_first', 'style' => 'square'],
                        ['key' => 'lbs_all', 'name' => 'menus.distance_first', 'style' => 'square'],
                ...
                'woman'   => [
                    ['key' => 'lbs_all', 'name' => 'menus.all_boys', 'style' => 'list'],
                    ['key' => 'lbs_online', 'name' => 'menus.online_first', 'style' => 'list'],
                    ['key' => 'lbs_vip', 'name' => 'menus.vip_boys', 'style' => 'list'],
                    ['key' => 'lbs_girl', 'name' => 'menus.girls', 'style' => 'list']
                ],
