...
class WgcYunPayPocket extends BasePocket
{
     ...
     * @throws \Exception
     */
    public function pay(int $tradeWithdrawId, $operatorId = 0)
    {
        $time = time();
    ...
    public function recordRequest($trans, $contact, $time, $mess, $requestId, $orderId, $operatorId) : int
    {
        ...
        try {
            ...
            logger()->setLogType('wgc_request_record_error')->error($exception->getMessage());
        }
     ...
     * @throws \Exception
     */
    public function preRepay($tradeWithdrawId) : ResultReturn
    {
    ...
    public function getBalance() : array
    {
        ...
        $acctBalance = $cardInfo[0]['acct_balance'] ?? 0;
