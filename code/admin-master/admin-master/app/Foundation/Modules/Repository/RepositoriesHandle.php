...
use App\Repositories\AdminFunctionMappingRepository;
use App\Repositories\OperatorSpecialLogRepository;
 ...
 * @property AdminOperationLogRepository    adminOperationLog
 * @property AdminFunctionMappingRepository adminFunctionMapping
 * @property OperatorSpecialLogRepository   operatorSpecialLog
...
class RepositoriesHandle
{
    protected static $registerList = [
        ...
        'adminOperationLog'    => AdminOperationLogRepository::class,
        'adminFunctionMapping' => AdminFunctionMappingRepository::class,
        'operatorSpecialLog'   => OperatorSpecialLogRepository::class,
